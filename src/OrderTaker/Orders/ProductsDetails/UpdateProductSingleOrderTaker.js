...
const UpdateProductSingleOrderTaker = ({ match }) => {
	...
	return (
		<UpdateProductSingleOrderTakerWrapper>
			{!collapsed ? (
...
export default UpdateProductSingleOrderTaker;

const UpdateProductSingleOrderTakerWrapper = styled.div`
	min-height: 880px;
	overflow-x: hidden;
	/* background: #ededed; */
