...
const InvoicePDF2 = (props) => {
	...
	console.log(updateSingleOrder.exchangedProductQtyWithVariables, "exchanged");
		...
		<InvoicePDF2Wrapper>
			...
			<div id='content' className='container'>
				...
				<div style={{ fontSize: "1.1rem" }}>
					<h1 style={{ color: "darkblue" }}>Exchange Order</h1>
					<div className='row'>
						<div className='col-6'>
							Order Date: <br />
				...
				<table className='table table-md-responsive table-hover'>
					...
					<tbody
						...
						{updateSingleOrder &&
							updateSingleOrder.exchangedProductQtyWithVariables &&
							updateSingleOrder.exchangedProductQtyWithVariables.map((s, i) => {
								return (
									<tr key={i} className=''>
										<td
											className='my-auto'
										...
										<td>{Number(s.OrderedQty)}</td>

										<td>{Number(s.priceAfterDiscount).toFixed(2)}</td>
										<td>
											{Number(
												Number(s.priceAfterDiscount) * Number(s.OrderedQty),
											).toFixed(2)}
										</td>
									</tr>
								);
				...
				<div
					...
					<div className='row'>
						...
						<div className='col-5'>
							<div className='row'>
								<div className='col-6'>Subtotal Before Exchange</div>
								<div className='col-5'>
						...
						<div className='col-5'>
							<div className='row'>
								<div className='col-6'>Subtotal After Exchange</div>
								<div className='col-5'>
									{Number(updateSingleOrder.totalAmountAfterExchange).toFixed(
										2,
									)}{" "}
									L.E.
								</div>
...
const InvoicePDF2Wrapper = styled.div`
	margin-top: 40px;
